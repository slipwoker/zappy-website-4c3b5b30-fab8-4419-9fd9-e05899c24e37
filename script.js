document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    const getErrorMessage = function (field, rule, ruleValue) {
      const label =
    ...
    const validateField = function (field) {
      ...
      for (let i = 0; i < rules.length; i++) {
        ...
        const ruleValue = parts[1] ? parts[1].trim() : null;

        if (ruleName === 'required' && !validators.required(value)) {
          showError(field, getErrorMessage(field, 'required', ruleValue));
          return false;
        }
        ...
        if (validators[ruleName] && !validators[ruleName](value, ruleValue)) {
  ...
  const animatableElements = Array.prototype.slice.call(
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "חלילים משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '4c3b5b30-fab8-4419-9fd9-e05899c24e37',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '4c3b5b30-fab8-4419-9fd9-e05899c24e37';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '4c3b5b30-fab8-4419-9fd9-e05899c24e37';
